...
private
  ...
  def item_params
    params.require(:item).permit(:name,:description,:price,:inventory).with_defaults(image: 'https://snellservices.com/wp-content/uploads/2019/07/image-coming-soon.jpg')
  end
